...
import futuristicoffensiveanddefenseive.theneonfish.fod.transporter.TransporterManager;
import futuristicoffensiveanddefenseive.theneonfish.fod.items.ItemBlockBasic;
...
import futuristicoffensiveanddefenseive.theneonfish.fod.utils.TransporterUtils;
...
public class TileEntityBin extends TileEntityBasicBlock implements ISidedInventory, IActiveState, IConfigurable
{
	...
	public void handlePacketData(ByteBuf dataStream)
	{
		...
		FODUtils.updateBlock(worldObj, xCoord, yCoord, zCoord);
	}
	...
	public void markDirty()
	{
		...
		{
			FODUtils.saveChunk(this);
			MainFOD.packetHandler.sendToReceivers(new TileEntityMessage(Coord4D.get(this), getNetworkedData(new ArrayList())), new Range4D(Coord4D.get(this)));
