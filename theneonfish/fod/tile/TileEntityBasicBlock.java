...
public abstract class TileEntityBasicBlock extends TileEntity implements IWrenchable, ITileNetwork, IChunkLoadHandler {
	...
	public void updateEntity()
	{
		...
		if(!worldObj.isRemote)
		{
			...
			if(doAutoSync && playersUsing.size() > 0)
			{
				...
				{
					MainFOD.packetHandler.sendTo(new TileEntityMessage(Coord4D.get(this), getNetworkedData(new ArrayList())), (EntityPlayerMP)player);
				}
			}
		}
	...
	public void validate()
	{
		...
		if(worldObj.isRemote)
		{
			MainFOD.packetHandler.sendToServer(new DataRequestMessage(Coord4D.get(this)));
		}
	}
