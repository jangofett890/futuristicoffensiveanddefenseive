...
public abstract class TileEntityElectricBlockFOD extends TileEntityContainerBlockFOD implements IEnergyWrapper{
	 ...
	 */
	public TileEntityElectricBlockFOD(String name, double baseMaxEnergy)
	{
		super(name);
