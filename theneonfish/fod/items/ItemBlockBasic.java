...
import futuristicoffensiveanddefenseive.theneonfish.fod.inventory.InventoryBin;
...
public class ItemBlockBasic extends ItemBlock implements IEnergizedItem
{
    ...
    {
		if(Block.getBlockFromItem(this) == FODBlocks.BasicBlock && stack.getItemDamage() == 6)
		{
